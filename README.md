...
- [ ] Orders
  - Don't select order items from other dates / Dynamic number of items
  - [x] Validate Stock (don't add more the stock)
  - Optional unit price (only for updates)
  - Display orders for the day
  - Display daily menu items
- [x] Sales
